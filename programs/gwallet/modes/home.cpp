...
void Home::CreateControls()
{
   ...
   m_timer_slow.Start(30000);

   auto info = p_GWallet->wallet.wallet_api_ptr->info();
   // wdump((info));

   auto head_block_number_value = fc::json::to_string(info["head_block_num"]);

   auto head_block_age_string = fc::json::to_string(info["head_block_age"]);
   auto head_block_age_value = head_block_age_string.substr(1, head_block_age_string.length()-2);

   auto next_maintenance_time_string = fc::json::to_string(info["next_maintenance_time"]);
   auto next_maintenance_time_value = next_maintenance_time_string.substr(1, next_maintenance_time_string.length()-2);

   auto participation_string = fc::json::to_string(info["participation"]);
   auto participation_value = participation_string.substr(1, participation_string.length()-2);

   auto about = p_GWallet->wallet.wallet_api_ptr->about();

   auto client_version_string = fc::json::to_string(about["client_version"]);
   auto client_version_value = client_version_string.substr(1, client_version_string.length()-2);

   auto graphene_revision_string = fc::json::to_string(about["graphene_revision"]);
   auto graphene_revision_value = graphene_revision_string.substr(1, graphene_revision_string.length()-2);

   auto graphene_revision_age_string = fc::json::to_string(about["graphene_revision_age"]);
   auto graphene_revision_age_value = graphene_revision_age_string.substr(1, graphene_revision_age_string.length()-2);

   auto fc_revision_string = fc::json::to_string(about["fc_revision"]);
   auto fc_revision_value = fc_revision_string.substr(1, fc_revision_string.length()-2);

   auto fc_revision_age_string = fc::json::to_string(about["fc_revision_age"]);
   auto fc_revision_age_value = fc_revision_age_string.substr(1, fc_revision_age_string.length()-2);

   auto compile_date_string = fc::json::to_string(about["compile_date"]);
   auto compile_date_value = compile_date_string.substr(1, compile_date_string.length()-2);

   auto boost_version_string = fc::json::to_string(about["boost_version"]);
   auto boost_version_value = boost_version_string.substr(1, boost_version_string.length()-2);

   auto openssl_version_string = fc::json::to_string(about["openssl_version"]);
   auto openssl_version_value = openssl_version_string.substr(1, openssl_version_string.length()-2);

   auto build_string = fc::json::to_string(about["graphene_revision"]);
   auto build_value = build_string.substr(1, build_string.length()-2);
   ...
   auto account_name_value = account.name;
   auto account_id_string = fc::json::to_string(account.id);
   auto account_id_value = account_id_string.substr(1, account_id_string.length()-2);
   // wdump((account));
   ...
   wxStaticText* itemStaticText5 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Head block number:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer4->Add(itemStaticText5, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   head_block_num = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, head_block_number_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText8 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Block age:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer7->Add(itemStaticText8, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   head_block_age = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, head_block_age_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText2 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Next maintenance time:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer1->Add(itemStaticText2, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   next_maintenance_time = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, next_maintenance_time_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText7 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Participation:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer5->Add(itemStaticText7, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   participation = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, participation_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText12 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Active witnesses:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer11->Add(itemStaticText12, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxHyperlinkCtrl* itemHyperlinkCtrl13 = new wxHyperlinkCtrl( itemStaticBoxSizer3->GetStaticBox(), ID_VIEW_WITNESSES, _("View"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_ALIGN_LEFT );
   ...
   wxStaticText* itemStaticText15 = new wxStaticText( itemStaticBoxSizer3->GetStaticBox(), wxID_STATIC, _("Active committee:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer14->Add(itemStaticText15, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxHyperlinkCtrl* itemHyperlinkCtrl16 = new wxHyperlinkCtrl( itemStaticBoxSizer3->GetStaticBox(), ID_VIEW_COMMITTEE, _("View"), wxEmptyString, wxDefaultPosition, wxDefaultSize, wxHL_ALIGN_LEFT );
   ...
   wxStaticText* itemStaticText4 = new wxStaticText( itemStaticBoxSizer1->GetStaticBox(), wxID_STATIC, _("Name:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer2->Add(itemStaticText4, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   account_name = new wxStaticText( itemStaticBoxSizer1->GetStaticBox(), wxID_STATIC, account_name_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText13 = new wxStaticText( itemStaticBoxSizer1->GetStaticBox(), wxID_STATIC, _("ID:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer12->Add(itemStaticText13, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   account_id = new wxStaticText( itemStaticBoxSizer1->GetStaticBox(), wxID_STATIC, account_id_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText16 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("Client version:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer3->Add(itemStaticText16, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText17 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, client_version_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText18 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("Graphene revision:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer6->Add(itemStaticText18, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText19 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, graphene_revision_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText21 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("Revision age:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer20->Add(itemStaticText21, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText22 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, graphene_revision_age_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText24 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("FC revision:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer23->Add(itemStaticText24, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText25 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, fc_revision_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText27 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("FC revision age:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer26->Add(itemStaticText27, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText28 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, fc_revision_age_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText30 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("Compile date:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer29->Add(itemStaticText30, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText31 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, compile_date_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText33 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("Boost version:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer32->Add(itemStaticText33, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText34 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, boost_version_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText36 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("OpenSSL version:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer35->Add(itemStaticText36, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText37 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, openssl_version_value, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText39 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, _("OS build:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer38->Add(itemStaticText39, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticText* itemStaticText40 = new wxStaticText( itemStaticBoxSizer2->GetStaticBox(), wxID_STATIC, build_value, wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer38->Add(itemStaticText40, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   wxStaticBox* itemStaticBoxSizer41Static = new wxStaticBox(p_GWallet->panel, wxID_ANY, _("Market Prices"));
   ...
   wxStaticText* itemStaticText43 = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, _("USD/BTS:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer42->Add(itemStaticText43, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   usd_bts = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, usd_bts_ticker.latest, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText46 = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, _("CNY/BTS:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer45->Add(itemStaticText46, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   cny_bts = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, cny_bts_ticker.latest, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText49 = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, _("EUR/BTS:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer48->Add(itemStaticText49, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   eur_bts = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, eur_bts_ticker.latest, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText52 = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, _("GOLD/BTS:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer51->Add(itemStaticText52, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   gold_bts = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, gold_bts_ticker.latest, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText55 = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, _("SILVER/BTS:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer54->Add(itemStaticText55, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   silver_bts = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, silver_bts_ticker.latest, wxDefaultPosition, wxDefaultSize, 0 );
   ...
   wxStaticText* itemStaticText58 = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, _("BTC/BTS:"), wxDefaultPosition, wxDefaultSize, 0 );
   itemBoxSizer57->Add(itemStaticText58, 6, wxALIGN_CENTER_VERTICAL|wxALL, 5);

   btc_bts = new wxStaticText( itemStaticBoxSizer41->GetStaticBox(), wxID_STATIC, btc_bts_ticker.latest, wxDefaultPosition, wxDefaultSize, 0 );
